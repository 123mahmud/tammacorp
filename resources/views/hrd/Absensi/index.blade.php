                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div style="margin-left:-5px;">
                    ...
                    <div class="panel-body">
                    		<a href="javascript:void(0);" onclick="javascipt:window.open('{{url('/public/assets/berkas/absensi-manajemen/contoh-excel-manajemen.xlsx')}}');"><button class="btn btn-success">Download Contoh Master</button></a>
                    		<a href="javascript:void(0);" onclick="javascipt:window.open('{{url('/public/assets/berkas/absensi-manajemen/master-manajemen.xlsx')}}');"><button class="btn btn-success">Download ID Manajemen</button></a>
                    		<form
