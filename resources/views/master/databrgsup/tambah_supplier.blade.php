...
<div id="page-wrapper">
  ...
  <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left" style="font-family: 'Raleway', sans-serif;">
      <div class="page-title">Tambah Relasi Supplier ke Barang</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-right" style="font-family: 'Raleway', sans-serif;">
      ...
      <li>
        <i></i>&nbsp;Master&nbsp;&nbsp;
        <i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
      <li class="active">Tambah Relasi Supplier ke Barang</li>
    </ol>
    <div class="clearfix">
    </div>
  </div>
      ...
      <div class="row mbl">
        <div class="col-lg-12">
          ...
          <ul id="generalTab" class="nav nav-tabs">
            <li class="active">
              <a href="#alert-tab" data-toggle="tab">Tambah Relasi Supplier ke Barang</a>
            </li>
          </ul>
          <div id="generalTabContent" class="tab-content responsive">
            <div id="alert-tab" class="tab-pane fade in active">
              <div class="row">
                ...
                <div class="col-md-12">
                  <form method="POST" action="{{ url('master/databrgsup/simpan-relasi-supplier') }}" id="form_relasi_supplier">
                    {{ csrf_field() }}
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <input type="text" name="namasup" id="namasup" class="form-control input-sm ui-autocomplete-input" placeholder="Masukkan nama Supplier" autocomplete="off">
                            <input type="hidden" name="idsup" id="idsup" readonly="" class="form-control input-sm">
                          </div>
                        </div>
                      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() { 
    ...
    //autocomplete
    $( "#namasup" ).focus(function() {
       var key = 1;
       $( "#namasup" ).autocomplete({
          source: baseUrl+'/master/databrgsup/autocomplete-supplier',
          minLength: 1,
          select: function(event, ui) {
            $('#idsup').val(ui.item.id);
            $('#namasup').val(ui.item.label);
          }
       });
       $('#idsup').val("");
       $('#namasup').val("");
