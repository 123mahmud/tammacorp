                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 tamma-bg" style="margin-bottom: 20px; padding-bottom:5px;padding-top:20px; ">
                      ...
                      <div class="col-md-10 col-sm-9 col-xs-12">
                        <div class="form-group">
                          <input type="text" class="form-control input-sm" id="id" name="mp_name" value="{{ $rumah->mp_name }}">
                        </div>
                      </div>
                      <div class="col-md-12">
                      ...
                      <div class="col-md-10 col-sm-9 col-xs-12">
                        <div class="form-group">
                          <div class="input-icon right">
                            <input type="text" id="nama" name="mp_alamat" class="form-control input-sm" value="{{ $rumah->mp_alamat }}">
                          </div>
                        </div>
                      </div>
                    </div>
...
<script type="text/javascript">     
    ...
    function simpanData(){
      ...
      $.ajax({
        url: baseUrl + "/master/datapegawai/update-rumah/" + {{ $rumah->mp_id }},
        type:'get',
        data: $('#form-save').serialize(),
        success:function(response){
        toastr.success('Data Telah Terupdate!','Pemberitahuan')
