      ...
      <div class="col-md-12 col-sm-12 col-xs-12"  style="padding-bottom: 10px;">
         <div style="margin-left:-5px;">
            ...
            <div class="col-md-2" style="padding: 3px">
               <select name="jenis-opname" id="jenis-opname" class="form-control input-sm" onchange="getTanggal()">
         ...
         <div class="col-md-2" style="padding: 3px">
            <select name="pemilik-gudang" id="pemilik-gudang" class="form-control input-sm" onchange="getTanggal()">
