                                            ...
                                            <table class="table table-bordered" style="margin-bottom: 0px; background: white;">
                                              ...
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td class="text-center">
                                                    <input type="hidden" readonly name="persentase_gl" v-model='single_data.persentase_sm'>
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="text-center">
                                                    <input type="hidden" readonly name="persentase_sm" v-model='single_data.persentase_gl'>
